...
export const getClients = () => (dispatch) =>
  restClient
    .getAxios()
    .post(remote.api, { tag: 'get_all_clients' })
    .then((response) => {
      dispatch({
...
export const postClient = (client) => (dispatch) =>
  restClient
    .getAxios()
    .post(remote.api, { tag: 'add_client', client })
    .then((response) => {
      getClients()(dispatch);
...
export const getClient = (id) => (/* dispatch */) =>
  restClient
    .getAxios()
    .post(remote.api, { tag: 'get_client_by_id', cl_id: id })
...
export const updateClient = (client) => (dispatch) =>
  restClient
    .getAxios()
    .post(remote.api, { tag: 'update_client', client })
    .then((response) => {
      getClients()(dispatch);
...
export const deleteClient = (id) => (dispatch) =>
  restClient
    .getAxios()
    .post(remote.api, { tag: 'delete_client', id })
