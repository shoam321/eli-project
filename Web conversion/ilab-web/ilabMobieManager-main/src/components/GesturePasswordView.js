    ...
    return (
      <View style={styles.component.thumbnailPasswordMain}>
        ...
        <View style={styles.component.thumbnailPasswordContainer}>
          {thumbnail.map((row) => (
            <View key={row.key} style={styles.component.thumbnailPasswordItems}>
              {row.data.map((item) => (
                <View
                  key={item.value}
                  style={[
                    styles.component.thumbnailPasswordItem,
                    item.active
                      ? styles.component.thumbnailPasswordItemActive
                      : {},
                  ]}
                >
                  <Text style={styles.component.thumbnailPasswordItemText}>
                    {item.item}
                  </Text>
                </View>
              ))}
