...
export const projectStatusItems = [
  { id: projectStatus.OPEN, name: 'translation.open', color: colors.statusYellow },
  { id: projectStatus.FINISHED, name: 'translation.finished', color: colors.statusGreen },
  { id: projectStatus.CANCELED, name: 'translation.canceled', color: colors.statusRed },
  { id: projectStatus.DELAYED, name: 'translation.delayed', color: colors.statusYellow },
];

export const projectFilterItems = [
  { id: projectStatus.OPEN, name: 'translation.openDelayed', color: colors.statusYellow },
  { id: projectStatus.FINISHED, name: 'translation.finished', color: colors.statusGreen },
  { id: projectStatus.CANCELED, name: 'translation.canceled', color: colors.statusRed },
];
...
export const orderStatusItems = [
  { id: orderStatus.EXPECTED, name: 'translation.expected', color: colors.statusYellow },
  { id: orderStatus.RECEIVED, name: 'translation.received', color: colors.statusGreen },
  { id: orderStatus.MISSING, name: 'translation.missing', color: colors.statusYellow },
  { id: orderStatus.CANCELED, name: 'translation.canceled', color: colors.statusRed },
];
...
export const deviceStatusItems = [
  { id: deviceType.CLIENT, name: 'translation.client', color: colors.statusYellow },
  { id: deviceType.TEMPORARY, name: 'translation.temporary', color: colors.statusGreen },
  { id: deviceType.OWN, name: 'translation.own', color: colors.statusYellow },
  { id: deviceType.DELETED, name: 'translation.deleted', color: colors.statusRed },
];
