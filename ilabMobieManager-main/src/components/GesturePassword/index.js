...
export default class GesturePassword extends Component {
  ...
  render() {
    ...
    return (
      <SafeAreaView style={{flex: 1, backgroundColor: '#292B38'}}>
  ...
  getCrossChar(char) {
    ...
    const verticalMidle = (last === '1' && char === '7') || (last === '7' && char === '1');
    const horizontalMidle = (last === '3' && char === '5') || (last === '5' && char === '3');

    if ((middles.indexOf(char) > -1 || middles.indexOf(last) > -1) && !verticalMidle && !horizontalMidle) {
      return false;
    }
